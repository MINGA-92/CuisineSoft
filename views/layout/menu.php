  ...
  <div class="collapse navbar-collapse" id="menu">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="menaje">
          <a class="dropdown-item" href="http://localhost/CuisinePHP/views/Menaje/ConsultarMenaje.php">Consultar Menaje Disponible</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="http://localhost/CuisinePHP/views/Menaje/Modelo/RegistrarMenaje.php">Registrar Nuevo Menaje</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="http://localhost/CuisinePHP/views/Menaje/Modelo/RegistrarEventualidad.php" >Registrar Eventualidad Con Menaje</a>
        </div>
      </li>
      <li class="nav-item">
